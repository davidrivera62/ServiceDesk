...
AS FECHA_INICIO_TAREA_PROGRAMADA,DATEADD(HH,-5,(DATEADD(ss, dbo.chg.sched_end_date, '19700101 00:00:00')))  
AS FECHA_CIERRE_TAREA_PROGRAMADA,abs((chg. sched_start_date- chg.sched_end_date)/60) 
...
WHERE 
dbo.wf.group_id= 0xC5A1E42EEED4E04487E9FF4A2CF24DE0 AND dbo.wf.status<>'WAIT' AND  dbo.wf.status<>'PEND' AND dbo.wf.sequence = 10  
